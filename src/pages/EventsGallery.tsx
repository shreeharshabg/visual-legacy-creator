...
const EventsGallery = () => {
  ...
  const galleryImages = Array(12).fill(weddingImage);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              Timeless documentation of weddings, engagements, and cherished celebrations. Every moment preserved with elegance and emotion.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="relative overflow-hidden rounded-lg shadow-elegant hover:shadow-luxury transition-all duration-500">
                  <div className="aspect-[4/3] relative">
                    <motion.img
                      ...
                      src={image}
                      alt={`Event photography sample ${index + 1} by Sriharsha Photography`}
