...
const FashionGallery = () => {
  ...
  const galleryImages = Array(12).fill(fashionImage);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              Bold, editorial, and dynamic visuals for brands, designers, and models. Each image captures the essence of style, movement, and creative expression.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="relative overflow-hidden rounded-lg shadow-elegant hover:shadow-luxury transition-all duration-500">
                  <div className="aspect-[3/4] relative">
                    <motion.img
                      ...
                      src={image}
                      alt={`Fashion photography sample ${index + 1} by Sriharsha Photography`}
