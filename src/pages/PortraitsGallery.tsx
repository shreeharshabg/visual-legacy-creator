...
const PortraitsGallery = () => {
  ...
  const galleryImages = Array(12).fill(portraitImage);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              Capturing the unique personality of individuals for professional and creative branding. Every portrait tells a story of character and essence.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="relative overflow-hidden rounded-lg shadow-elegant hover:shadow-luxury transition-all duration-500">
                  <div className="aspect-[3/4] relative">
                    <motion.img
                      ...
                      src={image}
                      alt={`Portrait photography sample ${index + 1} by Sriharsha Photography`}
